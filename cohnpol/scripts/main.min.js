...
!function(a) {
    Zoomify = function(b, c) {
        var d = this;
        this._zooming = !1, this._zoomed = !1, this._timeout = null, this.$shadow = null, 
        this.$image = a(b).addClass("zoomify"), this.options = a.extend({}, Zoomify.DEFAULTS, this.$image.data(), c), 
        ...
        a("body").append(this.$shadow), this.addTransition(this.$shadow), this.$shadow.on("click", function() {
            b.zoomOut();
        }), setTimeout(function() {
...
$(".slider__text").addClass("animated bounce");

$(".download__click").addClass("animated flash");
...
$(".mainSlider__back").click(function() {
    $(".mainSlider").slick("slickPrev");
});

$(".mainSlider__next").click(function() {
    $(".mainSlider").slick("slickNext");
});

$(".gallery__box").zoomify({
    scale: .5,
    duration: 300
});
